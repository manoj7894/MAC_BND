...
function EditProfile() {
  ...
  const handleOnChange = (e) => {
    ...
    // Combine first name and last name into one variable "name"
        ...
        <form className={styleSheet.editProfile__form}>
          ...
          <div className={`${styleSheet.Form__inputRows_Primary}`}>
            <div className={styleSheet.Form__inputBox}>
              ...
              <input type="text" value={userDetails.name?.split(" ")[0]} name="firstName" id="firstName" placeholder="Enter your first name" className={styleSheet.Form__input} onChange={handleOnChange} />
            </div>

            <div className={styleSheet.Form__inputBox}>
              <label htmlFor="lastName" className={styleSheet.Form__inputBox_Label}>Last Name</label>
              <input type="text" name="lastName" value={userDetails.name?.split(" ")[1]} id="lastName" placeholder="Enter your last name" className={styleSheet.Form__input} onChange={handleOnChange} />
            </div>
          </div>
          ...
          <div className={`${styleSheet.Form__inputRows_Secondry}`}>
            ...
            <input type="email" value={userDetails.email} name="email" id="email" placeholder="Enter your email address" className={styleSheet.Form__input} onChange={handleOnChange} />
          </div>

          {/* Phone number */}
          <div className={`${styleSheet.Form__inputRows_Secondry}`}>
            <label htmlFor="phone" className={styleSheet.Form__inputBox_Label}>Phone</label>
            <input type='tel' pattern="[0-9]{10}" value={userDetails.phone_number} name="phone_number" id="phone" placeholder="Enter your phone number" className={styleSheet.Form__input} onChange={handleOnChange} maxLength="10" />
          </div>

          {/* WEbsites*/}
          <div className={`${styleSheet.Form__inputRows_Secondry}`}>
            <label htmlFor="website" className={styleSheet.Form__inputBox_Label}>Website</label>
            <input type="text" value={userDetails.website} name="website" id="website" placeholder="Enter your website link" className={styleSheet.Form__input} onChange={handleOnChange} />
          </div>
          ...
          <div className={`${styleSheet.Form__inputRows_Primary}`}>
            ...
            <div className={styleSheet.Form__inputBox}>
              ...
              <select value={userDetails.marital_status} className={`${styleSheet.Form__input} ${styleSheet.Form__Select_input}`} name="marital_status" onChange={handleOnChange}>
            ...
            <div className={styleSheet.Form__inputBox}>
              ...
              <input type="date" name="dob" id="dob" value={userDetails.dob?.split("T")[0]} className={styleSheet.Form__input} onChange={handleOnChange} />
            </div>
          </div>
          ...
          <div className={`${styleSheet.Form__inputRows_Primary}`}>
            <div className={styleSheet.Form__inputBox}>
              ...
              <select value={userDetails.gender} className={`${styleSheet.Form__input} ${styleSheet.Form__Select_input}`} onChange={handleOnChange} name="gender">
            ...
            <div className={styleSheet.Form__inputBox}>
              ...
              <select value={userDetails.country} name="country" className={`${styleSheet.Form__input} ${styleSheet.Form__Select_input}`} onChange={handleOnChange}>
          ...
          <div className={`${styleSheet.Form__inputRows_Primary}`}>
            <div className={styleSheet.Form__inputBox}>
              ...
              <input type="text" name="college" value={userDetails.college} id="college" placeholder="Enter College or university name" className={styleSheet.Form__input} onChange={handleOnChange} />
            </div>

            <div className={styleSheet.Form__inputBox}>
              <label htmlFor="course" className={styleSheet.Form__inputBox_Label}>course</label>
              <input type="text" name="course" value={userDetails.course} id="course" placeholder="Enter course name" className={styleSheet.Form__input} onChange={handleOnChange} />
            </div>
          </div>

          <div className={`${styleSheet.Form__inputRows_Secondry}`}>
            <label htmlFor="percentage" className={styleSheet.Form__inputBox_Label}> percentage</label>
            <input type="number" value={userDetails.percentage} name="percentage" id="percentage" placeholder="Enter your percentage" className={styleSheet.Form__input} onChange={handleOnChange} />
          </div>
          ...
          <div className={`${styleSheet.Form__inputRows_Primary}`}>
            <div className={styleSheet.Form__inputBox}>
              ...
              <input type="text" name="job_title" value={userDetails.job_title ?? ""} id="jobTitle" placeholder="Enter job title" className={styleSheet.Form__input} onChange={handleOnChange} />
            </div>

            <div className={styleSheet.Form__inputBox}>
              <label htmlFor="companyName" className={styleSheet.Form__inputBox_Label}>Company Name</label>
              <input type="text" name="company" value={userDetails.company ?? ""} id="companyName" placeholder="Enter company name" className={styleSheet.Form__input} onChange={handleOnChange} />
            </div>
          </div>
          ...
          <div className={`${styleSheet.Form__inputRows_Secondry}`} style={{ "width": "100%" }}>
            ...
            <textarea className={styleSheet.Form_About_textArea} placeholder="Write about yourself" id="about" name="biography" value={userDetails?.biography} onChange={handleOnChange}></textarea>
          </div>
