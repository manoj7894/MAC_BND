...
function MyResume() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      // Trigger re-fetch of resumes data to update PreviousResume component
      // No need to manually refresh the page
      // This will automatically update the PreviousResume component
    } catch (error) {
  ...
  return (
    <>
      <form
        className={
          btn_Popup
            ? `${ResumeStyle.UploadPopUp_box}`
            : `${ResumeStyle.hidden_popup}`
        }
      >
        <i
          className="fa-solid fa-xmark"
          onClick={() => setbtnPopup(!btn_Popup)}
        ></i>
        <div className={ResumeStyle.inner_upload_Box}>
          ...
          <button
            ...
            className={ResumeStyle.inner_Upload_btn}
          >
            Upload
          </button>
        </div>
      ...
      <div
        className={
          btn_Popup
            ? `${ResumeStyle.blur_resume_container}`
            : `${ResumeStyle.resume_container}`
        }
      >
        <div className={ResumeStyle.resume_left_container}>
          <div className={ResumeStyle.resume_type_box}>
            <div
              className={
                resume_type === "myresume"
                  ? `${ResumeStyle.job_active}`
                  : `${ResumeStyle.typebox}`
              }
              onClick={() => setresume_type("myresume")}
            >
              <GrNotes />
            ...
            <div
              className={
                resume_type === "previous_resume"
                  ? `${ResumeStyle.job_active}`
                  : `${ResumeStyle.typebox}`
              }
              onClick={() => setresume_type("previous_resume")}
            >
              <GrNotes />
          ...
          <button
            className={ResumeStyle.Update_resumeBtn}
            onClick={() => setbtnPopup(!btn_Popup)}
          >
            Update Your Resume
          </button>
        ...
        <div className={ResumeStyle.resume_right_container}>
          <div className={ResumeStyle.resume_display}>
            ...
            <img
              src={image}
              alt="girl"
              className={ResumeStyle.right_image}
            ></img>
          ...
          <div className={ResumeStyle.resume_btn}>Check your resume score</div>
        </div>
      </div>
    </>
  );
